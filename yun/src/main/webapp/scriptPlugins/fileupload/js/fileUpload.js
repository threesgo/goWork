...
var uploadTools = {
    ...
    "initWithLayout":function(opt){
        ...
        //添加文件显示框
        var boxStr = "<div class='box_upload'></div>";
    ...
    "initWithDrag":function(opt){
        ...
        if(canDrag){
            ...
            var box = $("#"+uploadId+" .box_upload").get(0);
            if(box!=null){
                //验证图片格式，大小，是否存在
    ...
    "addFileList":function(fileList,opt){
        var uploadId = opt.uploadId;
        var boxJsObj =  $("#"+uploadId+" .box_upload").get(0);
    ...
    "uploadError":function(opt){
        ...
        $("#"+uploadId+" .box_upload .fileItem .status>i").addClass("iconfont icon-cha");
    ...
    "uploadSuccess":function(opt){
        var uploadId = opt.uploadId;
        $("#"+uploadId+" .box_upload .fileItem .status>i").off();
        $("#"+uploadId+" .box_upload .fileItem .status>i").addClass("iconfont icon-gou");
        var progressBar = $("#"+uploadId+" .subberProgress .progress>div");
        progressBar.css("width","0%");
        progressBar.html("0%");
    },
    ...
    "getFileUploadPregressMsg":function(opt){
        var uploadId = opt.uploadId;
        $("#"+uploadId+" .box_upload .fileItem .status>i").removeClass();
        if(opt.uploadUrl=="#"||opt.uploadUrl==""){
