...
(function($) {
	...
	function _ef(_f0) {
		...
		function _f9(_104, pop) {
			var _tree = $(_104).closest("ul.tree");
			if(_tree.length==0)return null;
			return _tree.tree(pop ? "pop" : "getData",
					_104);
		}
		;
	...
	$.fn.tree.methods = {
		...
		reload : function(jq, _1a3, _call) {
			return jq.each(function() {
				if (_1a3) {
					...
					node.next().remove();
					_13d(this, _1a3 ,_call);
				} else {
					$(this).empty();
					_136(this, this , {}, _call);
				}
			});
		},
		...
		expand : function(jq, _1ad, _call) {
			return jq.each(function() {
				_13d(this, _1ad ,_call);
			});
		},
		...
		tr
				...
				.each(
						function() {
							...
							if (col && col.editor) {
								//添加编辑
								if(col.editor.onBefore && col.editor.onBefore.call(_719,_71a,row,col.editor.options,_71b)==false){
									return;
								}
								var _71c, _71d;
